      ...
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8'>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          <div>
            ...
            <div className='relative'>
              <textarea
                ...
                className='w-full px-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition font-mono text-sm placeholder:text-gray-400 dark:placeholder:text-gray-500'
                rows={8}
                disabled={isLoading}
                required
              />
              {saveData && !isLoading && (
                <button
                  ...
                  className='absolute top-2 right-2 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition'
                >
                  ✕
                </button>
              )}
          ...
          <button
            ...
            className='w-full bg-blue-600 dark:bg-blue-500 text-white font-medium py-3 px-4 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:cursor-not-allowed transition'
          >
        ...
        <footer className='mt-6 p-4 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg'>
